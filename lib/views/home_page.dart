...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Create an instance of CategoriesModel with your actual data
    ...
    return MaterialApp(
      ...
      home:
          HomePage(categoriesModel: categoriesModel), // Pass the instance here
    );
  }
}
...
class HomePage extends StatelessWidget {
  ...
  // Modify the constructor to accept an instance of CategoriesModel
